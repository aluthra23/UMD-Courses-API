...
def scrape_course_data_from_schedule_of_classes(course_acronym):
    ...
    for course in courses:
        ...
        classes = update_classes_data(course_number, open_sections,
...
def update_classes_data(course_number, open_sections, class_setting, section_title, section_min_credits,
                        section_max_credits, section_grading, description_fields):
    data = []
